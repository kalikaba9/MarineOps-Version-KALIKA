    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen px-6 md:px-12 lg:px-24 max-w-7xl">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-5xl font-bold text-white mb-6 leading-tight">
          ...
          maritimes avec <span className="text-cyan-400">MarineOps</span>
        ...
        <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl font-light leading-relaxed">
          Une plateforme unique pour commander tous vos services à terre : ravitaillement,
          transport, maintenance. Facile, rapide et fiable.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            <span className="text-lg">Explorer les services</span>
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-3xl tet mb-4">
            Pourquoi choisir MarineOps ?
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Une solution complète conçue pour optimiser la logistique de votre équipage
          </p>
        </div>
